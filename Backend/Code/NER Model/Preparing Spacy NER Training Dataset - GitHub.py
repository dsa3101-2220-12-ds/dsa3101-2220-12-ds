...
train_data = pd.read_csv('../../Data/NER_annotated_data/GitHub/gh_test.txt', sep='\t', quoting=3)
...
with open('../../Data/NER_annotated_data/GitHub/annotations.json', 'w') as f:
    json.dump(spacy_data, f)

# Converting JSON dataset manually into spaCy doc bin format
with open("../../Data/NER_annotated_data/GitHub/annotations.json", "r") as f:
    data = json.load(f)
...
doc_bin.to_disk("../../Data/NER_annotated_data/GitHub/annotations.spacy")