...
image_filename = 'sutdmod.png' # replace with your own image filename
image_path = os.path.join('assets', 'img', image_filename)
encoded_image = base64.b64encode(open(image_path, 'rb').read())

layout = html.Div([
    html.H1('SUTD Module Comparison', style={'text-align': 'center'}),
    html.Div([
        html.Div([
            ...
            dcc.Tabs(id='tabs', value='tab-text', children=[
                dcc.Tab(label='', value='tab-text', children=[
                    html.Div([
                        ...
                        html.Strong("Further Analytics for SUTD Course Curriculum", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                        html.P("Benchmarked against average schools which have 31.2 number of modules, as well as 53.1% with finals and 46.9% with projects. SUTD has 0.83 more number of modules, and 4.7% less finals and more project modules.", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                    ])
                ])
            ]),
