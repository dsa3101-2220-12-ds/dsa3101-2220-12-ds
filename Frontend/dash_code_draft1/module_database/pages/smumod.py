...
image_filename = 'smumod.png' # replace with your own image filename
image_path = os.path.join('assets', 'img', image_filename)
encoded_image = base64.b64encode(open(image_path, 'rb').read())

layout = html.Div([
    html.H1('SMU Module Comparison', style={'text-align': 'center'}),
    html.Div([
        html.Div([
            ...
            dcc.Tabs(id='tabs', value='tab-text', children=[
                dcc.Tab(label='', value='tab-text', children=[
                    html.Div([
                        ...
                        html.Strong("Further Analytics for SMU Course Curriculum", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                        html.P("Benchmarked against average schools which have 31.2 number of modules, 53.1% with finals and 46.9% with projects, as well as 45.2% foundational (levels 1 & 2) and 54.8% advanced (levels 3 & 4) modules. SMU has 7.27 less number of modules, 10.5% more finals and less project modules, and 0.6% more foundational and less advanced modules.", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                    ])
                ])
            ]),
