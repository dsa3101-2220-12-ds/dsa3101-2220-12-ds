...
layout = html.Div([
    html.H1('SUSS Module Comparison', style={'text-align': 'center'}),
    html.Div([
        html.Div([
            ...
            dcc.Tabs(id='tabs', value='tab-text', children=[
                dcc.Tab(label='', value='tab-text', children=[
                    html.Div([
                        ...
                        html.Strong("Further Analytics for SUSS Course Curriculum", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                        html.P("Benchmarked against average schools which have 31.2 number of modules, 53.1% with finals and 46.9% with projects, as well as 45.2% foundational (levels 1 & 2) and 54.8% advanced (levels 3 & 4) modules.SUSS has 0.83 more number of modules,14% less finals and more project modules, and 7.7% less foundational and more advanced modules. ", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                    ])
                ])
            ]),
