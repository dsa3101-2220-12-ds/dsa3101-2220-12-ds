...
image_filename = 'ntumod.png' # replace with your own image filename
image_path = os.path.join('assets', 'img', image_filename)
encoded_image = base64.b64encode(open(image_path, 'rb').read())

layout = html.Div([
    html.H1('NTU Module Comparison', style={'text-align': 'center'}),
    html.Div([
        html.Div([
            ...
            dcc.Tabs(id='tabs', value='tab-text', children=[
                dcc.Tab(label='', value='tab-text', children=[
                    html.Div([
                        ...
                        html.Strong("Further Analytics for NTU Course Curriculum", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                        html.P("Benchmarked against average schools which have 31.2 number of modules, 53.1% with finals and 46.9% with projects, as well as 45.2% foundational (levels 1 & 2) and 54.8% advanced (levels 3 & 4) modules. NTU has 4.17 less number of modules, 9.9% more finals and less project modules, and 28.9% more foundational and less advanced modules.", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                    ])
                ])
            ]),
