...
layout = html.Div([
    html.H1('SIT Module Comparison', style={'text-align': 'center'}),
    html.Div([
        html.Div([
            ...
            dcc.Tabs(id='tabs', value='tab-text', children=[
                dcc.Tab(label='', value='tab-text', children=[
                    html.Div([
                        ...
                        html.Strong("Further Analytics for SIT Course Curriculum", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                        html.P("Benchmarked against average schools which have 31.2 number of modules, as well as 45.2% foundational (levels 1 & 2) and 54.8% advanced (levels 3 & 4) modules. SIT has 5.17 less number of modules, and 1% more foundational and less advanced modules. ", style={'margin': 'auto', 'padding': '20px', 'fontSize': '22px'}),
                    ])
                ])
            ]),
